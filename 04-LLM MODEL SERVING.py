...
# MAGIC %md
# MAGIC # LLM SERVING (Llama-2-7B-Chat)

# COMMAND ----------

# MAGIC %md
# MAGIC Estimated Duration: 45 mins
# MAGIC
...
# MAGIC %md
# MAGIC ### INPUT OUTPUT SCHEMA AND EXAMPLE
